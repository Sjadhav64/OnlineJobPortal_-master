...
<head>
	...
	<title>Richa Jobs - <?php echo "$title"; ?></title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/logo.png" alt="Logo" height="50px" width="40px" /></a>
						</div>
					</div>
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="https://meet.google.com/?pli=1">Video Call</a>
							</li>
						</ul>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="mailto:richadiixt028@gmail.com">richadixit028@gmail.com</a></p>
								<p>Phone : <a href="tel:+91-9653035488">+91-9653XXXXXX</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Richa Dixit Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Richa Dixit and Akanksha</a></li>
								</ul>
